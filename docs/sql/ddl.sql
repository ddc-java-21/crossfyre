...
alter table if exists game add constraint FKggbqyowbcjj60mhpp2td22242 foreign key (user_puzzle_id) references user_puzzle;
alter table if exists solution_word add constraint FKp8hcr0hrq4fwjy21h4shggx39 foreign key (solution_puzzle_id) references solution_puzzle;
alter table if exists user_puzzle add constraint FKnt5dqf3m5a84px3lidh3mm9gl foreign key (solution_puzzle_id) references solution_puzzle;
alter table if exists user_word add constraint FK8mf6onh6mbt9dx24fwopoj2d9 foreign key (user_puzzle_id) references user_puzzle;
